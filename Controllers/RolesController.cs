...
namespace ProjetPFA.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        public async Task<IActionResult> DeleteRole(string roleId)
        {
            ...
            if (role == null)
            {
                TempData["Error"] = "Le rôle n'existe pas.";
                return RedirectToAction(nameof(Index));
            }

            if ((await _userManager.GetUsersInRoleAsync(role.Name)).Any())
            {
                TempData["Error"] = "Impossible de supprimer le rôle car il est toujours attribué à des utilisateurs.";
                return RedirectToAction(nameof(Index));
            }
            ...
            {
                TempData["Error"] = "Erreur lors de la suppression du rôle : " + result.Errors.FirstOrDefault()?.Description;
            }

            return RedirectToAction(nameof(Index));  // Assurez-vous de cette redirection
        }
