...
namespace ProjetPFA.Seeds
{
    public static class DefaultUsers
    {
        ...
        private static async Task SeedClaimsForSuperUser(this RoleManager<IdentityRole> roleManager)
        {
            ...
            await roleManager.AddPermissionClaims(adminRole, "Marketing");
            await roleManager.AddPermissionClaims(adminRole, "Enseingant");
            await roleManager.AddPermissionClaims(adminRole, "Etudiant");
            await roleManager.AddPermissionClaims(adminRole, "Finance");
            await roleManager.AddPermissionClaims(adminRole, "Modele");
        }
